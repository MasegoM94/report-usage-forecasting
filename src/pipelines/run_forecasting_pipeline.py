        ...
        [
            {
                ...
                "mase_lag1": metrics.get("mase_naive"),
                "bias": metrics.get("bias_naive"),
            },
            {
                ...
                "mase_lag1": metrics.get("mase_seasonal_naive"),
                "bias": metrics.get("bias_seasonal_naive"),
            },
            {
                "model_name": "sarima",
                ...
                "mase_lag1": metrics.get("mase_arima"),
                "bias": metrics.get("bias_arima"),
            },
        ]
    )
    ...
    for rid in passing_data_ids:
        ...
        try:
            ...
            metrics = {
                ...
                "bias_seasonal_naive": np.nan,
                "mase_seasonal_naive": np.nan,
